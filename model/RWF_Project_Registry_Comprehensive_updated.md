...
> - **RTE_TEST_SCORE_GAIN = 0.137 SD (ITT)**: Changed from ToT 0.23 to ITT estimate
> - **Sector-specific wage growth**: FORMAL 1.5%/yr, INFORMAL -0.2%/yr (replaces uniform 0.01%)
> - **benefits_adjustment ELIMINATED**: PLFS wages are now single source of truth
> - **Decomposition analysis**: Placement effect (79%) dominates over Mincer effect (21%)
> - RTE NPV ≈ ₹7.96 Lakhs (urban male baseline with P_FORMAL_RTE=30%)
...
**RAZONAMIENTO (UPDATED Jan 20, 2026):**

```
EWS Child → RTE Seat in Private School → Better Learning Outcomes (+0.137 SD ITT)
    → Higher Secondary Completion → Higher P(Formal Sector) → Higher Lifetime Earnings
```

**4-Pathway Model (Jan 2026 - Anand guidance):**

| Pathway | P(Formal) | Mincer Premium | Description |
|---------|-----------|----------------|-------------|
| Control Formal | 9.1% | None | National baseline, no education boost |
| Control Informal | 90.9% | None | National baseline, no education boost |
| **RTE Formal** | **30%** | **6.7%** | Selection effects + networks + Mincer |
| **RTE Informal** | **70%** | **6.7%** | Mincer applies even to informal |
...
**ARTEFACTO/OUTPUT (UPDATED Jan 20, 2026):**

* Treatment effect: \+**0.137 SD** test scores (NBER w19441) - ***ITT estimate*** (was ToT 0.23)
* Equivalencia: 0.137 SD × 6.8 years/SD \= **0.93** equivalent years → **6.7% wage premium**
* **P_FORMAL_RTE = 30%** (NEW): Separate from national baseline 9.1%
* **Decomposition**: Placement effect (79%) > Mincer effect (21%)

**ESTADO:** Complete - Updated Jan 20, 2026
...
| Fuente | Uso | Documento | Status |
| ----- | ----- | ----- | ----- |
| NBER w19441 | RTE test score gain (0.23 SD) | Muralidharan & Sundararaman 2015 | Current |
| **Angrist & Evans 2020** | Test Score → Years (**6.8** yr/SD) | Micro-LAYS methodology | **Updated Jan 2026** |
| **ILO India Employment Report 2024** | Formal sector multiplier (**2.25×**) | Urban 2.24×, Rural 2.48× | **Updated Jan 2026** |
| MSDE Annual Report 2023-24 | Apprentice absorption rate (72%) | RWF validated data | Current |
| DGT National Tracer Study | Vocational premium (4.7%) | 2019-20 ITI proxy | Current |
| **Murty & Panda 2020** | Social discount rate (**8.5%**) | Ramsey formula for India | **Updated Jan 2026** |
| **Mitra 2019** | Mincer return HS (**7.0%**) | Via Chen et al. 2022 | **Updated Jan 2026** |
| **Gazette 2019** | Apprentice stipend (**₹7,000/mo**) | Ministry notification | **Updated Jan 2026** |
| ASER 2023-24 | Counterfactual schooling distribution | Survey data | Current |
...
* β₁ \= **0.07** (Mincer return per year of schooling) - *Updated Jan 2026 from Mitra 2019*
* β₂ \= 0.00885 (experience linear coefficient)
* β₃ \= \-0.000123 (experience quadratic \- diminishing returns)
* FM \= **2.25** (formal sector multiplier) - *Documentation only - benefits_adjustment ELIMINATED Jan 20, 2026*
* g_formal \= **0.015** (1.5%/year formal wage growth) - *NEW Jan 20, 2026*
* g_informal \= **-0.002** (-0.2%/year informal wage stagnation) - *NEW Jan 20, 2026*
* δ \= **0.085** (social discount rate) - *Updated from Murty & Panda 2020*

**CRITICAL UPDATE (Jan 20, 2026):**
* **benefits_adjustment ELIMINATED**: PLFS wages already differentiate formal (₹32,800) vs informal (₹13,425) - ratio 2.44× exceeds ILO target 2.25×
* **Sector-specific wage growth**: Formal workers progress (1.5%/yr), informal stagnates (-0.2%/yr) - captures growing inequality
...
### **PARÁMETRO CRÍTICO \#2: P(Formal | Higher Secondary)**

| Fuente | Valor | Razonamiento |
| ----- | ----- | ----- |
| PLFS Nacional (histórico) | 20% | Promedio nacional para Higher Secondary |
| **ILO India Employment Report 2024** | **9.1%** | Youth formal employment rate - *UPDATED Jan 2026* |
| Modelo actual (conservativo) | **9.1%** | Alineado con ILO 2024 |
| Range para scenarios | 5%-15% | Conservative to optimistic |

**Actualización Jan 2026:**

* El valor anterior de 20% (PLFS) era optimista
* ILO India Employment Report 2024 muestra que solo **9.1%** de jóvenes HS graduates tienen empleo formal
* Este es un valor más conservador y empíricamente respaldado
* **Impacto:** P_FORMAL_HIGHER_SECONDARY es el parámetro con mayor sensitividad (75.9% NPV impact)

**ARTEFACTO/OUTPUT:**

\# En parameter\_registry\_v3.py (v3.3)
P\_FORMAL\_HIGHER\_SECONDARY \= Parameter(
    value=0.091,  \# Updated from 0.20
    min\_val=0.05,
    max\_val=0.15,
    tier=1,
...
**ESTADO:** \[RESOLVED\] \- Updated to ILO 2024 value (9.1%)

---

### **PARÁMETRO CRÍTICO \#2B: P(Formal | RTE) - NEW Jan 20, 2026**

| Fuente | Valor | Razonamiento |
| ----- | ----- | ----- |
| National baseline (P_FORMAL_HS) | 9.1% | Control group - no RTE effect |
| **P_FORMAL_RTE (NEW)** | **30%** | RTE graduates - 3.3× baseline |
| Range para scenarios | 20%-50% | Conservative to optimistic |

**Nueva adición (Jan 20, 2026 - Anand guidance):**

* RTE graduates from quality private schools have **higher formal sector entry** than national baseline
* Rationale: (1) Selection effects in RTE families, (2) Urban concentration, (3) Private school networks
* Anand guidance: "70% too high, 30-40% defensible" → **30% used as central value**
* **Impacto:** P_FORMAL_RTE (30%) vs P_FORMAL_HS (9.1%) = **21pp advantage**

**Decomposition Analysis Results:**

| Effect | NPV Contribution | Share |
|--------|-----------------|-------|
| Placement Effect (30% vs 9.1%) | ₹6.28 L | **79%** |
| Mincer Effect (6.7% premium) | ₹1.68 L | **21%** |
| **Total** | **₹7.96 L** | 100% |

**ARTEFACTO/OUTPUT:**

```python
# En parameter_registry_v3.py (v3.4)
P_FORMAL_RTE = Parameter(
    name="Formal Sector Entry Probability (RTE Graduates)",
    symbol="P(F|RTE)",
    value=0.30,  # 30% - 3.3× national baseline
    unit="probability",
    tier=1,
    sensitivity_range=(0.20, 0.50),
    notes="RTE-specific. Higher than 9.1% due to selection effects, urban concentration, private school networks"
)
```

**ESTADO:** \[NEW\] \- Added Jan 20, 2026 per Anand guidance
...
| ----- | ----- | ----- | ----- |
| Mincer Return (HS) | **7.0%** | \[5.0%, 9.0%\] | Mitra 2019 via Chen et al. 2022 |
| Social Discount Rate | **8.5%** | \[6%, 10%\] | Murty & Panda 2020 (Ramsey formula) |
| RTE Test Score Gain | 0.23 SD | \[0.10, 0.35\] | Muralidharan 2013 (ToT) |
| Vocational Premium | 4.7% | \[3%, 6%\] | DGT Study |
| Test Score to Years | **6.8** | \[4.0, 8.0\] | Angrist & Evans 2020 (micro-LAYS) |
...
| Parámetro | Valor | Range | Fuente |
| ----- | ----- | ----- | ----- |
| Formal Multiplier | **2.25×** | \[2.24, 2.48\] | ILO India Employment Report 2024 |
| Working Life (Formal) | 40 years | Fixed | Standard retirement |
| Working Life (Informal) | 47 years | Fixed | Extended working |
| Entry Age | 22 years | Fixed | Post-HS average |
| Apprentice Stipend | **₹7,000/mo** | \[5,000, 9,000\] | Gazette notification 2019 |
...
## **10B. DUAL BCR ANALYSIS (Feb 2026)**

### **[2026-02-03] | [TAG: METHODOLOGY/BCR]**

**HITO/ACCIÓN:** Implementation of dual BCR framework providing two ROI perspectives

**RAZONAMIENTO:** Different funders interpret costs differently:
- **Full BCR**: Total benefits / Total investment (RWF + govt + private co-finance)
- **RWF-only BCR**: Total benefits / RWF direct spend (funder ROI perspective)

This allows stakeholders to understand:
1. Overall program economics (Full BCR)
2. RWF's specific ROI on their direct investment (RWF-only BCR)
3. The "unlock multiplier" - how much total investment each RWF rupee unlocks

### **Cost Parameter Structure:**

| Parameter | RTE | Apprenticeship | Source |
|-----------|-----|----------------|--------|
| **RWF Direct Cost** | ₹4,000 | ₹6,000 | RWF operational data |
| **Govt/Private Unlocked** | ₹1,00,000 | ₹1,52,460 | Fee reimbursement / NATS |
| **Total Investment** | ₹1,04,000 | ₹1,58,460 | Sum of above |
| **Unlock Multiplier** | 26× | 39.6× | Total / RWF direct |
...
For upfront costs: PV(costs) ≈ cost_per_beneficiary (Year 0)
```

### **Dual BCR Results (Feb 2026):**

| Metric | RTE | Apprenticeship |
|--------|-----|----------------|
| **Average LNPV** | ₹14.9 Lakhs | ₹36.4 Lakhs |
| **BCR (Full Investment)** | 14.3× (range 5.4-29.0) | 23.0× (range 12.5-35.0) |
| **BCR (RWF-only)** | 372× (range 141-755) | 606× (range 329-924) |
| **Unlock Multiplier** | 26× | 39.6× |

### **Sensitivity to Discount Rate (Urban Male West baseline):**

| Discount Rate | RTE LNPV | RTE BCR (Full) | RTE BCR (RWF) | App LNPV | App BCR (Full) | App BCR (RWF) |
|---------------|----------|----------------|---------------|----------|----------------|---------------|
| 3% (low) | ₹32.8L | 31.5× | 819× | ₹74.9L | 47.2× | 1,248× |
| 5% (central) | ₹23.5L | 22.6× | 588× | ₹53.4L | 33.7× | 889× |
| 8% (high) | ₹15.7L | 15.1× | 393× | ₹35.1L | 22.2× | 585× |
...
## **29\. INTERACTIVE VERIFICATION TOOL - MANUAL REVIEW SCRIPT**

### **\[2026-01-12\] | \[TAG: VERIFICATION/TOOLING/MANUAL_REVIEW\]**

**HITO/ACCIÓN:** New `verify_interactive.py` script for conversational, manual deep-dive verification of individual documents with full context

**RAZONAMIENTO:**

The automated batch verification (`verify_claims_simple.py`) handles systematic verification across many documents, but researchers need a complementary tool for:
1. **Deep investigation** of conflicting or ambiguous results (PARTIAL, low confidence)
2. **Exploratory analysis** of new documents before formal verification
3. **Component validation** for derived parameters (validate calculation inputs)
4. **Iterative questioning** without PDF reloading overhead

This tool enables **conversation with documents** rather than one-shot verification.

**ARTEFACTO/OUTPUT:**

**Script:** `verify_interactive.py` (~350 lines)

**Core Features:**
1. **Conversational interface** - Ask multiple questions, document stays in memory
2. **Full document context** - Loads entire PDF (no chunking/truncation)
3. **Parameter-aware** - Fuzzy-loads parameter definitions from CSV
4. **Structured output** - Answer + snippets + thinking + confidence
5. **Expert methodology** - Uses same `LLM_Prompt_Expert.md` as batch system

**Key Functions:**
```python
extract_pdf_text() - Loads complete PDF
load_parameter_definitions() - Reads parameters_verified.csv
get_parameter_context() - Fuzzy match + context loading
ask_llm() - Question + doc + param context → LLM
interactive_mode() - Conversation loop
format_result() - Pretty-print structured output
```
...
**C. Interactive conversation (recommended):**
```bash
...
[LLM analysis with snippets + thinking]

🔍 Your question: Does this vary by gender or sector?
...
- `param <name>` - Load parameter context (case-insensitive substring match)
- `exit` / `quit` / `q` - Exit session
- Any other text - Send as question to LLM

**Configuration (hardcoded):**
```python
SOURCES_DIR = Path('sources')  # PDF directory
CSV_PATH = 'parameters_verified.csv'  # Parameter definitions
...
{
  "answer": "Main answer...",
  "thinking_process": "Search strategy and reasoning...",
  "relevant_snippets": [
    {"page": "5", "text": "Exact quote..."},
    {"page": "12", "text": "Another quote..."}
  ],
  "confidence": 85,
...
**Terminal display** includes:
- Answer section
- Relevant snippets (with page numbers)
- Thinking process (LLM's search methodology)
...
1. **Automated batch verification:**
   ```bash
   python verify_claims_simple.py --category "0-VETTING"
   ```

2. **Filter weak results:**
   - CSV filter: `verification_status IN (NO_EVIDENCE, ERROR, PARTIAL)`
   - Or: `confidence_score < 70`

3. **Manual deep-dive:**
   ```bash
   python verify_interactive.py --doc "<weak_doc>" --param "<param>" --interactive
   ```

4. **Update and re-verify:**
   - If convincing evidence found → update CSV `source_document_filename`
   - Re-run: `python verify_claims_simple.py --force-reverify`

**Use Cases:**

**Case 1: Investigate PARTIAL result**
```bash
# verify_claims_simple.py returned PARTIAL (60% conf) for "Mincer Return"
python verify_interactive.py \
  --doc "chen_kanjilal_bhaduri_2022.pdf" \
  --param "Mincer Return" \
  --interactive
...
# - "Are there caveats about external validity?"
# - "Can I derive this from wage tables?"
```

**Case 2: Explore new document**
```bash
python verify_interactive.py --doc "new_study.pdf" --interactive

# Questions:
# - "What is this paper about?"
# - "Does it mention India labor markets?"
# - param apprentice
# - "Does it discuss apprenticeship programs?"
```

**Case 3: Validate derived parameter**
```bash
python verify_interactive.py --doc "PLFS_2023_24.pdf" --interactive

# Sequential validation:
# 1. "What is the formal sector wage?"
# 2. "What is the informal sector wage?"
# 3. "Calculate the ratio"
# 4. "What is P(Formal|Higher Secondary)?"
```
...
|---------|------------------------|----------------------|
| Purpose | Automated batch | Manual exploration |
| Input | CSV + filters | Single doc + questions |
| Document | Chunked (100k) | Full (no chunking) |
| Mode | Batch | Conversational |
| Output | Updates CSV | Terminal (JSON) |
| Context | Claim-specific | Full parameter def |
| Speed | Slow (many docs) | Medium (one doc) |
| Use case | Systematic | Investigate specific |
...
**Parameter matching:** Case-insensitive substring matching
- CSV: `"Mincer Return (Higher Secondary)"`
- User: `param Mincer` → ✓ Match

**Context loaded per parameter:**
- parameter_name
- claimed_value
- category
- usage_in_model
- credibility_limitations (caveats)
- source_citation

**FILES MODIFIED:**

- `verify_interactive.py` - **NEW** (~350 lines)
- `README_NEW_VERIFICATION_SYSTEM.md` - Updated with usage guide

**DOCUMENTATION:**

- Full guide: `README_NEW_VERIFICATION_SYSTEM.md` (section 1)
- Changelog: `docs/PROJECT_CHANGELOG.md` (§2026-01-12-interactive)
- Help: `python verify_interactive.py --help`

**IMPACTO:**

**Before:**
- Manual verification = open PDF → read → copy-paste to ChatGPT
- No parameter context
- No structured output
- Repetitive for multi-question investigation

**After:**
- Load PDF once → ask many questions
- Parameter context auto-injected
- Structured output (snippets + thinking + confidence)
- Same expert methodology as batch system
- **~5-10x faster** for manual review workflow

**Expected usage:** ~10-20 parameters will need manual review after batch verification. This tool streamlines that process significantly.

**ESTADO:** ✅ Complete - Production ready, tested, documented

---

## **30\. DOCUMENT ANALYSIS SCRIPT - ENHANCED VERSION**

### **\[2026-01-12\] | \[TAG: VERIFICATION/TOOLING/OPTIMIZATION\]**

**HITO/ACCIÓN:** Complete rewrite of `analyze_unused_docs.py` with full directory scanning, dual-layer caching, LLM retry logic, and new document discovery

**RAZONAMIENTO:**

**Previous limitations:**
- Only analyzed documents with ERROR/NO_EVIDENCE status from CSV
- No discovery of newly added PDFs
- Re-extracted PDFs every run (2-5s per document overhead)
- No retry on LLM failures (180s timeout)
- Could not re-analyze verified documents for additional matches

**New capabilities implemented:**
1. **Full directory scanning** - Scans entire `sources/` directory, compares against CSV, discovers new documents
2. **Dual-layer PDF caching** - Memory cache (instant) + disk cache (persistent, 30× speedup on re-runs)
3. **LLM retry with extended timeout** - 300s timeout (vs 180s) + 1 automatic retry on failure
4. **Flexible analysis modes** - Can include already-verified documents, custom status filtering
5. **Enhanced CSV output** - New `is_new_document` boolean flag to distinguish new vs existing docs

**KEY TECHNICAL IMPROVEMENTS:**

**Caching System:**
```python
# Layer 1: In-memory cache (instant lookup)
_pdf_text_memory_cache: Dict[str, str] = {}

# Layer 2: Disk cache (persistent across runs)
CACHE_DIR = Path('.cache/pdf_texts')
cache_file = CACHE_DIR / f"{pdf_stem}_{md5_hash}.pkl"

# Performance: 150s → 5s on re-runs (30× speedup)
```

**LLM Retry Logic:**
```python
def llm_suggest_parameters_with_retry(
    doc_text, doc_name, all_parameters, excluded_params,
    max_retries=1, timeout=300.0  # 5 minutes
):
    for attempt in range(max_retries + 1):
        try:
            response = httpx.post(..., timeout=timeout)
            return result
        except (TimeoutException, HTTPStatusError, JSONDecodeError):
...
def scan_sources_directory(sources_dir: Path) -> List[str]:
    """Scan and compare filesystem vs CSV."""
    all_pdfs = sorted([f.name for f in sources_dir.glob('*.pdf')])
    csv_docs = set(df['source_document_filename'].dropna().unique())

    for pdf in all_pdfs:
        if pdf in csv_docs:
            # Existing: preserve info
            original_params = [...]
            original_status = '...'
            is_new = False
        else:
            # New: mark as NEW_DOCUMENT
            original_params = []
            original_status = 'NEW_DOCUMENT'
            is_new = True
```
...
dgt_msde_2024_tracer_study.pdf,True,NEW_DOCUMENT,NEW_DOCUMENT,NATS_Vocational_Premium,92.3,llm_analysis,"...","...."
muralidharan_2013.pdf,False,Test Score Gain,PARTIAL,Formal Sector Access,78.5,keyword_matching,"",""
```

**New CLI flags:**
```bash
--scan-all              # Scan entire sources/ directory (not just CSV)
--include-verified      # Match against CONSISTENT/PARTIAL parameters too
--no-cache             # Disable caching (force re-extraction)
--no-llm               # Keyword-only mode (fast, no LLM calls)
--debug                # Verbose output
--status X Y           # Custom status filtering (backwards compatible)
--output FILE          # Custom output CSV path
```

**Usage examples:**
```bash
# NEW: Discover all documents (including new ones)
python3 analyze_unused_docs.py --scan-all

# Check if verified docs match OTHER parameters
python3 analyze_unused_docs.py --scan-all --include-verified

# Fast mode (keyword-only, no LLM)
python3 analyze_unused_docs.py --scan-all --no-llm
...
**Cache performance (50 documents, 2nd run):**
- Memory cache hits: 45 (90%)
- Disk cache hits: 5 (10%)
- Fresh extractions: 0 (0%)
- Total extraction time: 5s (vs 150s)

**KEY FEATURES PRESERVED:**
- ✅ Keyword matching (fast pre-filter)
- ✅ LLM analysis with full parameter catalog
- ✅ Batched LLM calls (1 call evaluates ALL parameters)
...
1. `analyze_unused_docs.py` → Suggests which documents might verify which parameters
2. Review suggestions CSV → Prioritize high-score (>70) matches
3. `verify_claims_simple.py` → Verify top suggestions with full LLM analysis
4. Repeat cycle as new documents added

**WORKFLOW EXAMPLE:**
```bash
# Step 1: Initial scan (builds cache)
python3 analyze_unused_docs.py --scan-all
# Output: document_reuse_analysis.csv (50 docs, ~25 min)

# Step 2: User adds new_study.pdf to sources/

# Step 3: Re-run (fast, only analyzes new doc)
python3 analyze_unused_docs.py --scan-all
# Output: Updated CSV with new_study.pdf matches (~2 min)

# Step 4: Verify top suggestions
python3 verify_claims_simple.py --category X --limit 5
```

**KNOWN LIMITATIONS:**

1. **Cache size grows unbounded** - Manual cleanup needed: `rm -rf .cache/pdf_texts/`
2. **Hash recalculation overhead** - ~50ms per document (acceptable vs 2-5s savings)
3. **No automatic cache expiration** - But hash-based keys detect content changes

**FILES MODIFIED:**

- `analyze_unused_docs.py` - Complete rewrite (809 lines)
  - Lines 1-36: Updated docstring
  - Lines 63-77: Caching configuration
  - Lines 89-165: Dual-layer caching implementation
  - Lines 171-330: LLM retry logic
  - Lines 336-349: Directory scanning
  - Lines 407-577: Enhanced document analysis
  - Lines 584-808: Expanded main() with new workflows

**FILES CREATED:**

- `.cache/pdf_texts/` - Auto-created directory for persistent cache
...
- [x] Directory scanning accurate
- [x] New document detection working
- [x] CSV output includes `is_new_document` column
- [x] All CLI flags documented in `--help`
- [x] Performance improvements verified (30× speedup)

**RELATED DOCUMENTATION:**

- Full technical changelog: `docs/PROJECT_CHANGELOG.md` (§2026-01-12)
- Script help: `python3 analyze_unused_docs.py --help`
- Integration guide: See verification pipeline workflow above

**ESTADO:** ✅ Complete - Production ready, all features implemented and tested
...
| 2.0 | 2026-01-12 | Added §29: Document Analysis Script Enhanced - Full directory scanning, dual-layer caching (30× speedup), LLM retry logic, new document discovery |
| **2.1** | **2026-01-18** | **CSV SSOT Sync**: Updated 6 key parameters from validated literature review. Synced economic_core_v4.py (v4.3) and parameter_registry_v3.py (v3.3). Sensitivity analysis results: RTE NPV ₹618K, Apprenticeship NPV ₹3.2M. All breakeven_margin = 100 (robust interventions). |

---

**END OF REGISTRY**

*Last Updated: January 18, 2026* *Maintainer: Maxi*

---

# **PARTE X: PHASE 1 MODEL ALIGNMENT (January 2026)**

---

## **PHASE 1 ALIGNMENT EXECUTION**

### **\[2026-01-14\] | \[TAG: ALIGNMENT/PHASE1/CRITICAL\]**

**HITO/ACCIÓN:** Phase 1 Model Alignment between `parameter_registry_v3.py` and `economic_core_v4.py`

**RAZONAMIENTO:** After extensive development and multiple parameter updates, the two core model files had accumulated discrepancies that needed systematic resolution. Phase 1 alignment established `parameter_registry_v3.py` as the Single Source of Truth (SSOT) and aligned critical parameters.

**COMPLETION STATUS:** **100% COMPLETE** (all tasks executed January 14, 2026)

### **Key Achievements**

#### **1. Critical Parameter Alignment**

| Parameter | Old v4 | New v4 (aligned) | Source | Impact |
|-----------|--------|------------------|--------|--------|
| `P_FORMAL_APPRENTICE` | 0.75 | **0.72** | RWF validated data | -4% LNPV (more realistic) |
| `P_FORMAL_HIGHER_SECONDARY` | 0.20 | **0.40** | Moderate scenario | +100% LNPV (2x control) |
| `P_FORMAL_SECONDARY` | 0.11 | **0.12** | PLFS aggregate | +9% consistency |

#### **2. Parameter Range Updates**

- **REAL_WAGE_GROWTH**: `(0.0, 0.01)` → **`(-0.005, 0.01)`** asymmetric
  - Rationale: Allows for recession scenarios (negative growth empirically observed 2020-22)
  
- **EXPERIENCE_LINEAR**: `(0.005, 0.015)` → **`(0.005, 0.012)`**
  - Rationale: Narrower range matches PLFS 2023-24 cross-sectional data

- **EXPERIENCE_QUAD**: `(-0.0003, -0.00005)` → **`(-0.0002, -0.00005)`**
  - Rationale: Less negative concavity aligns with flatter wage-age profiles

#### **3. Scenario Framework Improvements**

- Established `parameter_registry_v3.py` as SSOT
- `economic_core_v4.py` ParameterRegistry defaults now match v3 'moderate' scenario
- `SCENARIO_CONFIGS['moderate']` converted to empty dict (uses registry defaults)
- Added `run_official_analysis()` wrapper for stakeholder reports

#### **4. Foundation for Double-Counting Fix**

- Added `get_embedded_ratio()` function in v3
- Documented embedded ratios for all demographics:
  - Urban Male: 1.944× (Rs 26,105 / Rs 13,425)
  - Urban Female: 2.177×
  - Rural Male: 1.640×
  - Rural Female: 1.658×
  - Average: 1.86×
...
* Modified files:
  - `parameter_registry_v3.py` (v3.0 → v3.1): ~80 lines changed
  - `economic_core_v4.py` (v4.0 → v4.1): ~70 lines changed
* Documentation:
  - `PHASE1_COMPLETION_REPORT.md`: Comprehensive 13-page report
  - `phase1_execution_log.md`: Task-by-task tracking
* Total execution time: ~45 minutes
* Files modified: 2/2

**ESTADO:** **COMPLETE** (100%)

### **Completed Tasks (January 14, 2026 - Session 2)**

#### **Phase 2: Baseline Wages**
- ✅ Task 2.3: Changed all baseline wage `sampling_method` from "normal" to **"fixed"**
  - Rationale: PLFS wages are measured data, not estimated parameters
  - Monte Carlo should not vary empirically observed wages

#### **Phase 4: Model Fixes (Already Implemented)**
- ✅ Task 4.2: `calculate_wage()` uses `get_embedded_ratio()` for variable ratio
- ✅ Task 4.3: RTE uses `P_FORMAL_HIGHER_SECONDARY × regional_multiplier`
- ✅ Task 4.4: `calculate_apprentice_control_trajectory()` added
- ✅ Task 4.5: `calculate_lnpv()` routes to intervention-specific counterfactual

#### **Phase 5: Monte Carlo**
- ✅ Task 5.1: `sample_parameters()` rewritten with explicit clamping:
  - Probabilities clamped to [0.0, 1.0]
  - `REAL_WAGE_GROWTH` clamped to [-0.005, 0.01]
  - `APPRENTICE_DECAY_HALFLIFE` clamped to [1, 100]
  - Added `P_FORMAL_NO_TRAINING` and `FORMAL_MULTIPLIER` to sampling

#### **Phase 6: Deprecation Markers**
- ✅ Task 6.1-6.2: Deprecated parameters marked in code:
  - `RTE_INITIAL_PREMIUM` - DEPRECATED (effect via schooling years)
  - `VOCATIONAL_PREMIUM` - DEPRECATED (use APPRENTICE_INITIAL_PREMIUM)
  - `APPRENTICE_YEAR_0_OPPORTUNITY_COST` - DEPRECATED (calculated endogenously)
  - `WORKING_LIFE_INFORMAL` - DEPRECATED (model uses WORKING_LIFE_FORMAL)

#### **Phase 7: Validation**
- ✅ Task 7.2: Created `validate_model_integrity.py` with 8 validation tests
  - All 8/8 tests pass
  - Verifies imports, parameter alignment, scenario configs, sampling methods
...
======================================================================
  ...
  Scenario Configs: [PASS]
  Baseline Wages Sampling: [PASS]
  Embedded Ratio: [PASS]
  Model Outputs: [PASS]
  Deprecation Markers: [PASS]
  Apprentice Control: [PASS]

Overall: 8/8 validations passed
```

### **Current Model Outputs (Post-Alignment)**

```
RTE Urban Male West LNPV: Rs 28.59L
Apprenticeship scenarios (Urban Male West):
  Conservative: ₹X.XL
  Moderate: ₹X.XL
  Optimistic: ₹X.XL
```

**Note**: LNPV values reflect corrected double-counting fix using embedded ratio.

---

## **OPEN LOOPS & NEXT STEPS**

### **\[2026-01-14\] | \[TAG: COMPLETED/PHASE1\]**

**OPEN LOOP:** Phase 1 Alignment **CLOSED**

✅ All tasks completed successfully on January 14, 2026

### **Next Steps (Post-Phase 1)**

**ACCIÓN NECESARIA:**
1. ✅ ~~Implement Tasks 4.2-4.5~~ - COMPLETE
2. ✅ ~~Implement Task 5.1~~ - COMPLETE
3. ✅ ~~Run validation suite (Task 7.2)~~ - COMPLETE (8/8 pass)
4. ⏳ Update stakeholder reports with corrected LNPV values
5. ⏳ Run full 32-scenario analysis with new model
6. ⏳ Generate Monte Carlo confidence intervals for stakeholder presentation

**FUTURE ENHANCEMENTS (Lower Priority):**
- Consider adding runtime deprecation warnings (Task 6.3 optional)
- Add unit tests for individual functions
- Create automated CI/CD validation pipeline

---

## **CSV SSOT SYNC (January 18, 2026)**

### **\[2026-01-18\] | \[TAG: SYNC/SSOT/PARAMETERS\]**

**HITO/ACCIÓN:** Complete synchronization of model files with Parameter_Sources_Master.csv (Single Source of Truth)

**RAZONAMIENTO:** Following the QA validation and merge of `Parameter_Sources_Findings.csv` and `all_matches.csv` into the Master CSV, the Python model files needed to be updated to reflect the validated parameter values from literature review.

**COMPLETION STATUS:** **100% COMPLETE**

### **Parameters Updated (6 Key Changes)**

| Parameter | Previous Value | New Value | Range (New) | Source |
|-----------|---------------|-----------|-------------|--------|
| `FORMAL_MULTIPLIER` | 2.0 | **2.25** | 2.24-2.48 | ILO India Employment Report 2024 |
| `SOCIAL_DISCOUNT_RATE` | 3.72% (0.0372) | **8.5%** (0.085) | 6%-10% | Murty & Panda 2020 (Ramsey formula) |
| `P_FORMAL_HIGHER_SECONDARY` | 20% (0.20) | **9.1%** (0.091) | 5%-15% | ILO India Employment Report 2024 |
| `MINCER_RETURN_HS` | 5.8% (0.058) | **7.0%** (0.07) | 5%-9% | Mitra 2019 via Chen et al. 2022 |
| `TEST_SCORE_TO_YEARS` | 4.7 | **6.8** | 4.0-8.0 | Angrist & Evans 2020 (micro-LAYS) |
| `APPRENTICE_STIPEND_MONTHLY` | ₹10,000 | **₹7,000** | ₹5,000-9,000 | Gazette notification 2019 |

### **Files Modified**

| File | Version | Changes |
|------|---------|---------|
| `economic_core_v4.py` | v4.2 → **v4.3** | Updated 6 parameter defaults + ranges |
| `parameter_registry_v3.py` | v3.2 → **v3.3** | Updated 6 parameter definitions + SCENARIO_CONFIGS |

### **Sensitivity Analysis Results**

After sync, `sensitivity_analysis_v2.py` was run to update the CSV columns C, D, E:

**Baseline NPV Values:**
- **RTE**: ₹618,693 per beneficiary
- **Apprenticeship**: ₹3,227,545 per beneficiary

**Top Sensitivity Parameters (RTE):**
| Rank | Parameter | NPV Impact % |
|------|-----------|-------------|
| 1 | P_FORMAL_HIGHER_SECONDARY | 75.9% |
| 2 | RTE_TEST_SCORE_GAIN | 52.6% |
| 3 | MINCER_RETURN_HS | 51.8% |

**Top Sensitivity Parameters (Apprenticeship):**
| Rank | Parameter | NPV Impact % |
|------|-----------|-------------|
| 1 | P_FORMAL_APPRENTICE | 56.4% |
| 2 | SOCIAL_DISCOUNT_RATE | 46.4% |
| 3 | FORMAL_MULTIPLIER | 41.2% |

**Break-even Analysis:**
- All parameters show `breakeven_margin = 100`, meaning NPV remains positive across the entire parameter range
- This indicates both RTE and Apprenticeship interventions are **robust** to parameter uncertainty

### **CSV Columns Updated**

| Column | Field | Description |
|--------|-------|-------------|
| C | `sensitivity_rank` | Tornado rank (1 = highest impact) |
| D | `npv_impact_pct` | % change in NPV when parameter varies across range |
| E | `breakeven_margin` | % headroom before NPV turns negative (100 = always positive) |

**ARTEFACTO/OUTPUT:**
- `Parameter_Sources_Master.csv` - Updated columns C, D, E with sensitivity results
- `economic_core_v4.py` (v4.3) - Synced parameter values
- `parameter_registry_v3.py` (v3.3) - Synced parameter values + scenarios
...
**CSV SSOT Sync:** **100% COMPLETE**
**Validation Status:** All parameters synced and sensitivity analysis updated
