...
UPDATED: December 12, 2024 (P_FORMAL_APPRENTICE revised to 72% from RWF data)
MILESTONE 2 COMPLETE: November 25, 2024 (Data Extraction with PLFS 2023-24)
...
- Apprentice placement rate validated at 72% (RWF actual data, Dec 2024)
...
APPRENTICE_COMPLETION_RATE = Parameter(
    ...
    CLARIFICATION (Dec 2024): This parameter is INDEPENDENT of placement rate.
    - P(Completion | Started) = 85% (this parameter)
    - P(Formal | Completion) = 72% (P_FORMAL_APPRENTICE, updated Nov 2024)
...
APPRENTICE_INITIAL_PREMIUM = Parameter(
    ...
    Updated from 75% to 72% based on RWF actual data (Nov 2024).
    """
)
